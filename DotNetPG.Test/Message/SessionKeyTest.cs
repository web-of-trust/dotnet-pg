...
public class SessionKeyTest
{
    ...
    private const string Rfc9580PublicKey = @"-----BEGIN PGP PUBLIC KEY BLOCK-----
...
-----END PGP PUBLIC KEY BLOCK-----";
    ...
    private const string Rfc9580PrivateKey = @"-----BEGIN PGP PRIVATE KEY BLOCK-----
...
-----END PGP PRIVATE KEY BLOCK-----";
    ...
    private const string AlicePublicKey = @"-----BEGIN PGP PUBLIC KEY BLOCK-----
...
-----END PGP PUBLIC KEY BLOCK-----";
    ...
    private const string AlicePrivateKey = @"-----BEGIN PGP PRIVATE KEY BLOCK-----
